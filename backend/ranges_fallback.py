# ranges_fallback.py — fallback reference ranges
...
#
# FIX: removed generic "glucose" key — it matched post-prandial and random glucose
# tests incorrectly against fasting range (70–100). Added explicit PP/random entries.

FALLBACK: dict[str, dict[str, tuple]] = {
    "hba1c":                  {"male": (4.0, 5.6),    "female": (4.0, 5.6)},
    "glycosylated":           {"male": (4.0, 5.6),    "female": (4.0, 5.6)},

    # Fasting glucose only — specific keys first so substring match hits these
    "fasting blood glucose":  {"male": (70.0, 100.0), "female": (70.0, 100.0)},
    "fasting blood sugar":    {"male": (70.0, 100.0), "female": (70.0, 100.0)},
    "fasting glucose":        {"male": (70.0, 100.0), "female": (70.0, 100.0)},
    "fbs":                    {"male": (70.0, 100.0), "female": (70.0, 100.0)},

    # Post-prandial / random — wider range
    "post prandial":          {"male": (None, 140.0), "female": (None, 140.0)},
    "post-prandial":          {"male": (None, 140.0), "female": (None, 140.0)},
    "postprandial":           {"male": (None, 140.0), "female": (None, 140.0)},
    "2 hour":                 {"male": (None, 140.0), "female": (None, 140.0)},
    "2-hour":                 {"male": (None, 140.0), "female": (None, 140.0)},
    "pp glucose":             {"male": (None, 140.0), "female": (None, 140.0)},
    "ppbs":                   {"male": (None, 140.0), "female": (None, 140.0)},
    "random blood sugar":     {"male": (None, 200.0), "female": (None, 200.0)},
    "random glucose":         {"male": (None, 200.0), "female": (None, 200.0)},
    "rbs":                    {"male": (None, 200.0), "female": (None, 200.0)},
    ...
    "vldl":                   {"male": (None, 30.0),  "female": (None, 30.0)},
